...
public class FiltrasiaVyvodNoutbooka {
    ...
    public FiltrasiaVyvodNoutbooka(Set<Notebook> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public FiltrasiaVyvodNoutbooka(Set<Notebook> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
